...
const Home = () => {
  return (
    <div
      id="home"
      className="relative min-h-[92vh] overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-blue-950"
    >
      {/* Background Decorative Blobs */}
      <div className="absolute top-[0%] left-[0%] w-64 h-64 bg-blue-400/30 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-[-10%] right-[-10%] w-72 h-72 bg-purple-400/30 rounded-full blur-3xl animate-pulse" />

      {/* Content */}
      <div className="relative z-10 p-8 md:p-12 bg-white/20 dark:bg-gray-800/30 backdrop-blur-md flex flex-col items-center text-center min-h-[92vh] gap-8 text-gray-800 dark:text-white transition-all">
